...
// given a number, will convert it to its negative
...
int main() {
	...
	// desired number in binary os 0000000000000011101


	// 1<<2 is 000000000000000100
	// num is  000000000000011001
	// so | is 000000000000011101
	num = num | (1<<2);
	Serial.println(num);


	// 1<<2 is 000000000000000100
	// num is  000000000000011101
	// so | is 000000000000011101
	num = num | (1<<2);
